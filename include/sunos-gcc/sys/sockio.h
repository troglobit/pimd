...
#define SIOCGETVIFCNT	_IOWR('r', 20, struct sioc_vif_req)/* get vif pkt cnt */
#define SIOCGETSGCNT	_IOWR('r', 21, struct sioc_sg_req) /* get s,g pkt cnt */
/* AH 96/9/23 added GETRPF for PIM support */
#define SIOCGETRPF	_IOWR('r', 22, struct rpfctl)     /* get rpf info */
#ifdef  RSVP_ISI
#define SIOCGETVIFINF   _IOWR('r', 15, struct vif_conf)   /* read m/c vifs  */
#endif  RSVP_ISI
